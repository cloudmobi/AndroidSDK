...
| ------------------------------- | --------------------- | ------------ |
| com.cloudtech:ads:3.3.5         | basic functions       | Y            |
| com.cloudtech:imageloader:3.3.5 | imageloader functions | N            |
| com.cloudtech:appwall:3.3.5     | appwall ads functions | N            |
| com.cloudtech:videoads:3.3.5    | video ads functions   | N            |
