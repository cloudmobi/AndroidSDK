...
* Please make sure you are using version 3.3.0
...
``` groovy
	...
	dependencies {
        compile 'com.cloudtech:ads:3.3.0'
        compile 'com.cloudtech:appwall:3.3.0'       // for appwall        
        compile 'com.cloudtech:imageloader:3.3.0'   // for imageloader
	}
...
``` groovy
	...
	dependencies {
	 ...
	     compile 'com.cloudtech:imageloader:3.3.0'
	}
```
