...
* Please make sure you are using version 3.3.7

| link name                       | link function         | require(Y/N) |
| ------------------------------- | --------------------- | ------------ |
| com.cloudtech:ads:3.3.7         | basic functions       | Y            |
| com.cloudtech:imageloader:3.3.7 | imageloader functions | N            |
| com.cloudtech:appwall:3.3.7     | appwall ads functions | N            |
| com.cloudtech:videoads:3.3.7    | video ads functions   | N            |

 * Update the module's build.gradle for basic functions：
 ``` groovy
    dependencies {
        compile 'com.cloudtech:ads:3.3.7'
    }
 ```
...
``` java 
    ...
    dependencies {
        compile 'com.cloudtech:ads:3.3.7'
        compile 'com.cloudtech:imageloader:3.3.7'   // for preload image
    } 
...
``` groovy
	...
	dependencies {
        	compile 'com.cloudtech:ads:3.3.7'
        	compile 'com.cloudtech:appwall:3.3.7'       // for appwall        
        	compile 'com.cloudtech:imageloader:3.3.7'   // for imageloader
	}
...
``` groovy
	...
	dependencies {
	     	compile 'com.cloudtech:ads:3.3.7'
	     	compile 'com.cloudtech:videoads:3.3.7'
	     	compile 'com.cloudtech:imageloader:3.3.7'
	}
```
